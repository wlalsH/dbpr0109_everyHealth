	...
	<div style="background-color: #333">
		<table>
			<tr>
				...
				<th align="right"><input type='button' id='btn' onclick="changeLogout()" value="로그인"></th>
				<th align="right">|</th>
				<th align="right"><a href=narvar.jsp " style="color: black">장바구니</a></th>
				<th align="right">|</th>
				<th align="right"><a href=narvar.jsp " style="color: black">마이페이지</a></th>
			</tr>
		</table>
	</div>
